...
const sections = [
  {
    ...
    content: "All data is stored locally in your browser's localStorage. This includes uploaded images, audit results, orders, analytics events, leads, referral data, challenge entries, progress comparisons, and user preferences. Nothing is uploaded to any external server.",
  },
  {
    title: "What is not collected",
    content: "AuraCheck does not collect your name, email, phone number, IP address, location, device information, or browsing history unless you voluntarily provide it (e.g., in a lead form). We do not use cookies, trackers, or analytics services.",
  },
  {
  ...
  },
  {
    ...
    content: "You can clear specific data types or all data from the Data Management page. Go to Settings → Your Local Data. Select what to clear and type DELETE to confirm. Alternatively, clearing your browser's site data will remove all AuraCheck data.",
  },
  {
    title: "How to export your data",
    content: "You can download all your local data as a JSON file from the Data Management page. This includes audits, orders, analytics, leads, and all other stored information.",
  },
  {
