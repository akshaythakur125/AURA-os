...
const faqs = [
  ...
  },
  {
    ...
    a: "After generating a free score, visit the Unlock page. Select the product (Full Aura Report, Dating Audit, or Glow-Up Plan), send payment via UPI to the displayed ID, and contact the owner with your transaction reference to receive an unlock code.",
  },
  {
