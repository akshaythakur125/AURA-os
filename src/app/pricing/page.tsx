...
const tiers = [
  ...
  },
  {
    ...
    price: String(Math.round(PAYMENT_PRODUCTS.aura_report.price / 100)),
  ...
  },
  {
    ...
    price: String(Math.round(PAYMENT_PRODUCTS.dating_audit.price / 100)),
  ...
  },
  {
    ...
    price: String(Math.round(PAYMENT_PRODUCTS.glowup_plan.price / 100)),
        ...
        <Container className="relative">
          ...
          <div className="mt-12 rounded-xl border border-red-500/10 bg-red-500/5 p-6 text-center">
            <p className="text-sm text-[#6f675e]">
              Secure one-time payment via Razorpay — UPI, card, or netbanking.
              No subscriptions, no recurring billing.
              <br />
              Your report unlocks instantly, the moment payment is confirmed.
            </p>
          </div>
          ...
          <div className="mt-12 space-y-4 text-center text-xs text-[#9c9184]">
            <p>Have an offer code? Enter it on the unlock page to get your discount.</p>
            ...
            <div className="mx-auto grid max-w-2xl gap-6 text-left">
              {[
                ...
                },
                {
                  ...
                  a: "Pay securely with Razorpay (UPI, card, or netbanking). Your full report unlocks instantly, the moment payment is confirmed — no waiting.",
                },
                {
                  q: "Is my data safe?",
