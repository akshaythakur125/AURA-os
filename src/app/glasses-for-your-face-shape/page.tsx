...
export const metadata: Metadata = {
  title: "Best Glasses for Your Face Shape — Free Face-Shape Finder | AuraCheck",
  description: "Find the most flattering glasses for your face shape. Free in-browser face-shape scan, frame recommendations for oval, round, square, oblong, heart and diamond faces.",
  alternates: { canonical: "/glasses-for-your-face-shape" },
};

export default function GlassesGuideIndex() {
  return (
    <Container className="py-12">
      <div className="mx-auto max-w-2xl">
        <p className="mb-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#B23A25]">Face-shape guide</p>
        <h1 className="text-3xl font-bold tracking-tight text-[#1C1917] sm:text-4xl">Best glasses for your face shape</h1>
        <p className="mt-4 text-base leading-relaxed text-[#4a443d]">
          The right frames balance your proportions; the wrong ones fight them. Pick your face shape below for a full guide — or let AuraCheck detect it from one photo, free and in your browser.
        </p>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {GLASSES_GUIDES.map((g) => (
            <Link
              key={g.slug}
              href={`/glasses-for-your-face-shape/${g.slug}`}
            ...
            >
              ...
              <p className="mt-1 text-xs text-[#6f675e]">Best glasses for a {g.shapeLower} face →</p>
            </Link>
          ))}
        </div>
      </div>
