...
const STEPS = [
  {
    ...
    desc: "Any selfie or profile pic. Any phone.",
    icon: (
  ...
  },
  {
    ...
    desc: "We score 7 signals — lighting, clarity, composition, background, colour, style, consistency.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: "A ranked plan: what to fix first, what to buy, where to shop.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
