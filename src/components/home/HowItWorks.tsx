...
const STEPS = [
  {
    num: "01",
    title: "Drop a pic",
    desc: "Selfie or profile pic. Any phone works.",
    icon: (
  ...
  },
  {
    ...
    desc: "7 signals — lighting, framing, styling, vibe. Measured, not guessed.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: "A ranked list of what to change first. No fluff.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <Container>
        <FadeInView>
          <div className="mb-12 text-center">
            ...
            <p className="mt-3 text-sm text-[#857b6e]">Three steps. One better photo.</p>
          </div>
        </FadeInView>
