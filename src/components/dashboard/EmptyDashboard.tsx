...
export function EmptyDashboard() {
  return (
    <Card className="py-12 text-center">
      ...
      <p className="mb-2 text-lg text-[#4a443d]">No audits yet</p>
      ...
      <div className="mt-8 mx-auto max-w-sm opacity-40">
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-xl border border-[#1c1917]/[0.08] bg-[#1c1917]/[0.02] p-3">
            <div className="text-[10px] text-[#9c9184]">Score Trend</div>
            <div className="mt-2 h-12 rounded bg-[#1c1917]/[0.03]">
          ...
          <div className="rounded-xl border border-[#1c1917]/[0.08] bg-[#1c1917]/[0.02] p-3">
            <div className="text-[10px] text-[#9c9184]">Days Since Check</div>
            <div className="mt-2 flex items-baseline gap-1">
              <span className="text-2xl font-bold text-[#1C1917]/20">--</span>
              <span className="text-[10px] text-[#9c9184]">days</span>
            </div>
          </div>
        </div>
        <div className="mt-3 rounded-xl border border-[#1c1917]/[0.08] bg-[#1c1917]/[0.02] p-3">
          <div className="text-[10px] text-[#9c9184]">Total Checks</div>
          <div className="mt-1 text-xl font-bold text-[#1C1917]/20">0</div>
        </div>
      </div>
    </Card>
  );
