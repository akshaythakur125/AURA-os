    ...
    <FadeInView>
      <div className="py-8">
        <div className="mb-4 text-center">
          <p className="text-xs text-gray-500 uppercase tracking-wider">Sample Score Ranges</p>
        </div>
        <div className="flex flex-wrap justify-center gap-2">
          {SAMPLE_SCORES.map((s) => (
            <div key={s.label} className="flex items-center gap-2 rounded-full border border-white/[0.04] bg-white/[0.02] px-3 py-1.5 text-xs">
