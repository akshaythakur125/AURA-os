...
export function GroomingPicksCard({ skin, hairNeatness }: { skin: Skin; hairNeatness?: number | null }) {
  ...
  if (skin.shine >= 55) {
    items.push({
      ...
      priceHint: "₹250–600",
      emoji: "🧴",
      query: "mattifying primer oil control face",
  ...
  if (skin.underEye >= 55) {
    items.push({
      ...
      priceHint: "₹300–700",
      emoji: "👁️",
      query: "under eye color corrector concealer",
  ...
  if (typeof hairNeatness === "number" && hairNeatness < 60) {
    items.push({
      ...
      priceHint: "₹200–500",
      emoji: "💇",
      query: "anti frizz hair smoothing serum",
  ...
  if (items.length === 0) {
    items.push({
      ...
      priceHint: "₹250–600",
      emoji: "🧴",
      query: "oil free moisturizer spf face",
