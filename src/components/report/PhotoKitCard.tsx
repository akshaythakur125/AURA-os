...
export function PhotoKitCard({ metrics }: { metrics: Metrics }) {
  ...
  if (lighting < 65 || faceDark) {
    items.push({
      ...
      priceHint: "₹600–1,500",
      emoji: "💡",
      query: "ring light for phone with tripod stand",
  ...
  if (sharp < 60) {
    items.push({
      ...
      priceHint: "₹300–800",
      emoji: "📷",
      query: "mobile phone tripod stand with bluetooth remote",
  ...
  if (bg > 55) {
    items.push({
      ...
      priceHint: "₹500–1,200",
      emoji: "🖼️",
      query: "collapsible photography backdrop plain grey",
  ...
  if (contrast < 35 || dull > 55) {
    items.push({
      ...
      priceHint: "₹500–900",
      emoji: "🔆",
      query: "5 in 1 photography reflector",
  ...
  if (items.length === 0) {
    items.push({
      ...
      priceHint: "₹200–500",
      emoji: "🎮",
      query: "bluetooth camera shutter remote for phone",
