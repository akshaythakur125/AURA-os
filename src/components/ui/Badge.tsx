...
const variants = {
  default: "bg-white/[0.07] text-gray-300 badge-embossed",
  ...
  premium: "bg-gradient-to-r from-purple-500/15 via-pink-500/15 to-blue-500/15 text-purple-300 badge-embossed aurora-border",
};
