              ...
              <div className="mb-8">
                <FunnelChart
                  ...
                  steps={[
                    ...
                    { name: "₹49 Paywall Viewed", count: ((d.metrics as Record<string, unknown>).overall as Record<string, unknown>).paywallViews as number, rate: ((d.metrics as Record<string, unknown>).rates as Record<string, unknown>).freeScoreToPaywall as number },
