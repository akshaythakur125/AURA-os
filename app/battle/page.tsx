    ...
    <Container className="py-12">
      <div className="mx-auto max-w-3xl">
        <div className="mb-10 text-center">
          ...
          <h1 className="mb-3 text-4xl font-bold text-white">You think you look better than your friend? Most people are wrong.</h1>
          <p className="text-sm text-gray-400">
            Drop two photos. We score both. No opinions, no bias — just what strangers actually see. The truth hurts sometimes.{battleCount > 0 && ` ${battleCount} people already found out.`}
          </p>
